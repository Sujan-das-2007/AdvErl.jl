...
Actors in Conduit communicate with extreme speed. Mailboxes have been upgraded to custom `AtomicMailbox` implementations running lock-free, circular ring buffers powered by `Atomix` and base Julia `Threads.Atomic`.
